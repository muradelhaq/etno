...
- [ ] **TASK-03 [P0 - Blocker]**: Buat dan publikasikan halaman web **Kebijakan Privasi (Privacy Policy)** publik yang mencakup pemrosesan data Supabase.
- [ ] **TASK-04 [P0 - Blocker]**: Tambahkan fitur **"Hapus Profil / Reset Data Pengguna"** di dalam aplikasi untuk mematuhi kebijakan penghapusan akun Google Play.
- [ ] **TASK-05 [P1 - Branding]**: Ubah `android:label` di `AndroidManifest.xml` dari `e_modul_etnosains` menjadi `E-Modul Etnosains`.
...
- [ ] **TASK-08 [P2 - Listing]**: Susun draf teks *Title*, *Short Description*, dan *Full Description* untuk Google Play Console.
