...
class ApersepsiData {
  static const List<FoodItemModel> modernFoods = [
    FoodItemModel(
      ...
      description: 'Makanan cepat saji global dengan roti bun hasil fermentasi ragi.',
    ),
    FoodItemModel(
      id: 'pizza',
      name: 'Pizza',
      ...
      description: 'Adonan roti beragi dengan topping keju hasil fermentasi bakteri asam laktat.',
    ),
    FoodItemModel(
      id: 'kimchi',
      name: 'Kimchi',
    ...
    FoodItemModel(
      ...
      description: 'Produk olahan susu fermentasi yang menyegarkan dan kaya probiotik.',
    ),
  ];
  ...
  static const List<FoodItemModel> traditionalFoods = [
    FoodItemModel(
      ...
      imageAsset: 'assets/images/image4.png',
      baseFermentationProduct: 'Tempe',
      description: 'Olahan tempe bumbu kecap gurih untuk memperpanjang daya simpan.',
    ),
    FoodItemModel(
      id: 'mendoan',
      name: 'Tempe Mendoan',
      ...
      imageAsset: 'assets/images/image4.png',
      baseFermentationProduct: 'Tempe',
      description: 'Tempe kedelai khas Banyumas digoreng setengah matang (mendo).',
    ),
    FoodItemModel(
      id: 'goyobod',
      ...
      description: 'Minuman dingin segar khas Jawa Barat dengan isian peuyeum singkong manis.',
    ),
    FoodItemModel(
      id: 'es_tape_ketan',
      name: 'Es Tape Ketan',
    ...
    FoodItemModel(
      ...
      category: 'Tradisional',
      imageAsset: 'assets/images/image5.png',
      baseFermentationProduct: 'Tauco',
      description: 'Masakan ikan berkuah gurih dengan fermentasi kedelai garam Cianjur.',
    ),
    FoodItemModel(
      id: 'tutug_oncom',
      ...
      category: 'Tradisional',
      imageAsset: 'assets/images/image4.png',
      baseFermentationProduct: 'Oncom',
      description: 'Nasi hangat ditumbuk bersama oncom bakar bumbu kencur gurih.',
    ),
    FoodItemModel(
      id: 'combro',
      ...
      imageAsset: 'assets/images/image4.png',
      baseFermentationProduct: 'Oncom',
      description: 'Gorengan parutan singkong berisi tumisan oncom pedas wangi.',
    ),
  ];
}
